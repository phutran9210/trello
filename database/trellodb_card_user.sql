...
CREATE TABLE `card_user` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `card_user_ibfk_1` FOREIGN KEY (`card_id`) REFERENCES `cards` (`card_id`) ON DELETE CASCADE,
  CONSTRAINT `card_user_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `card_user` VALUES ('2','702d840b48'),('3','b1b0a38ad4'),('1','fe5b2169cd');
